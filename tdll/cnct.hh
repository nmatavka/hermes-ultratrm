...
struct stCnctPrivate
	...
	WCHAR achDllName[256];			// name of file containing driver
	...
	int (WINAPI *pfSetDestination)(const HDRIVER hDriver, WCHAR *const ach, const size_t cb);
	int (WINAPI *pfGetComSettingsString)(const HDRIVER hDriver, LPWSTR pachStr, const size_t cb);
	};
