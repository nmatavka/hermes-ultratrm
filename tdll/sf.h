...
int sfOpenSessionFile(const SF_HANDLE, const WCHAR *);
...
int sfGetSessionFileName(const SF_HANDLE, const int, WCHAR *);

int sfSetSessionFileName(const SF_HANDLE, const WCHAR *);
