...
BOOL backscrlAdd(const HBACKSCRL hBackscrl,
	...
	pachBackscrl[hBk->iOffset++] = ECHAR_CAST('\n');
 ...
 *	pwOffset	- offset into retrieved page (in WCHAR units).
 *
 * RETURNS:
 *	BOOL
 *
