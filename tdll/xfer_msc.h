...
// extern int xfrSendAddToList(HSESSION hSession, LPCWSTR pszFile);

extern int xfrSendAddToList(HXFER hXfer, LPCWSTR pszFile);

// extern int xfrSendListSend(HSESSION hSession);

extern int xfrSendListSend(HXFER hXfer);

// extern int xfrRecvStart(HSESSION hSession, LPCWSTR pszDir, LPCWSTR pszName);

extern int xfrRecvStart(HXFER hXfer, LPCWSTR pszDir, LPCWSTR pszName);
