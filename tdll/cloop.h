...
extern WCHAR  CLoopGetWaitChar(const HCLOOP hCLoop);
extern void   CLoopSetWaitChar(const HCLOOP hCLoop, WCHAR chWaitChar);
...
extern int SetCLoopHostWidthState(HCLOOP hCLoop, int nState);
extern int QueryCLoopHostWidthState(HCLOOP hCLoop);

extern void CLoopByteOut(HCLOOP hCLoop, BYTE bOut);
extern void CLoopBytesOut(HCLOOP hCLoop, const void *pvOut, int nLen);
extern void CLoopCharOut(HCLOOP hCLoop, WCHAR chOut);
extern void CLoopBufrOut(HCLOOP hCLoop, WCHAR *pchOut, int nLen);
...
extern int	  CLoopSend
					...
					const size_t	sztItems,
						  unsigned	uOptions);
extern int	  CLoopSendTextFile(const HCLOOP hCLoop, WCHAR *pszFileName);
