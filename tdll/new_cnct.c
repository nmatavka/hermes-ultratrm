...
INT_PTR CALLBACK NewConnectionDlg(HWND hDlg, UINT wMsg, WPARAM wPar, LPARAM lPar)
	...
	static const WCHAR *apszBadNames[] =
		{
	...
	switch (wMsg)
	    ...
	    case WM_INITDIALOG:
		    ...
		    StrCharCopyN(pS->achSessName, ach, sizeof(pS->achSessName)/sizeof(WCHAR));
            ...
            */
            ...
            switch (nId)
                ...
                case IDOK:
                    ...
                    //
                    ach[0] = L'\0';
                    nSelected = GetDlgItemText(hDlg, IDC_EF_NAME, ach, sizeof(ach) / sizeof(WCHAR));
