...
typedef struct SBR
	...
	// LoadString() calls.
	//
	LPWSTR		pachCNCT;					// Connected + time...
	LPWSTR		pachCAPL;					// CAP Lock label
	LPWSTR		pachNUML;					// NUM Lock label
	LPWSTR		pachSCRL;					// SCR Lock label
	LPWSTR		pachPECHO;					// Print Echo label
	LPWSTR		pachCAPT;					// Capture label
	LPWSTR		pachCOM;					// Com label
