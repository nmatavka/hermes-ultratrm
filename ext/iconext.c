...
STDMETHODIMP IconExt_CTM_QueryInterface(LPEXTRACTICON pctm, REFIID riid,
	LPVOID FAR* ppvOut);
...
// Vtable prototype
//
typedef struct _ULTRATERMINAL_EXTRACTICON_VTBL
	{
	HRESULT (STDMETHODCALLTYPE *QueryInterface)(LPEXTRACTICON, REFIID, LPVOID FAR*);
	UINT (STDMETHODCALLTYPE *AddRef)(LPEXTRACTICON);
	UINT (STDMETHODCALLTYPE *Release)(LPEXTRACTICON);
	HRESULT (STDMETHODCALLTYPE *GetIconLocation)(LPEXTRACTICON, UINT, LPWSTR,
		UINT, int *, UINT *);
	HRESULT (STDMETHODCALLTYPE *Extract)(LPEXTRACTICON, LPCWSTR, UINT, HICON *,
		HICON *, UINT);
	} ULTRATERMINAL_EXTRACTICON_VTBL;

extern ULTRATERMINAL_EXTRACTICON_VTBL c_SampleIconExt_CTMVtbl;
...
HRESULT CALLBACK IconExt_CreateInstance(LPUNKNOWN punkOuter,
    ...
    psmx->_ctm.lpVtbl = (IExtractIconVtbl *)&c_SampleIconExt_CTMVtbl;
    ...
    // failed.
    //
    hres = IconExt_CTM_QueryInterface(&psmx->_ctm, riid, ppvOut);
    IconExt_CTM_Release(&psmx->_ctm);
...
#pragma data_seg(".text")
ULTRATERMINAL_EXTRACTICON_VTBL c_SampleIconExt_CTMVtbl =
	{
