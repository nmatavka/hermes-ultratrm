...
void EmuViewdataInit(const HHEMU hhEmu)
	...
	{0, ECHAR_CAST('\x20'),	ECHAR_CAST('\x7F'),	EmuViewdataCharDisplay},	// All
	{1, ECHAR_CAST('\x1B'),	ECHAR_CAST('\x1B'),	nothing},					// Esc
	{0, ECHAR_CAST('\x05'),	ECHAR_CAST('\x05'),	EmuViewdataAnswerback}, 	// Ctrl-E
	{0, ECHAR_CAST('\x08'),	ECHAR_CAST('\x08'),	EmuViewdataCursorLeft}, 	// Backspace
	{0, ECHAR_CAST('\x09'),	ECHAR_CAST('\x09'),	EmuViewdataCursorRight},	// Tab
	{0, ECHAR_CAST('\x0A'),	ECHAR_CAST('\x0A'),	EmuViewdataCursorDown}, 	// New Line
	{0, ECHAR_CAST('\x0B'),	ECHAR_CAST('\x0B'),	EmuViewdataCursorUp},		// VT
	{0, ECHAR_CAST('\x0C'),	ECHAR_CAST('\x0C'),	EmuViewdataClearScreen},	// Form Feed
	{0, ECHAR_CAST('\x0D'),	ECHAR_CAST('\x0D'),	carriagereturn},			// CR
	{0, ECHAR_CAST('\x11'),	ECHAR_CAST('\x11'),	EmuViewdataCursorSet},		// Ctrl-Q
	{0, ECHAR_CAST('\x14'),	ECHAR_CAST('\x14'),	EmuViewdataCursorSet},		// Ctrl-T
	{0, ECHAR_CAST('\x1E'),	ECHAR_CAST('\x1E'),	EmuViewdataCursorHome}, 	// Ctrl-^
	{0, ECHAR_CAST('\x80'),	ECHAR_CAST('\xFF'),	EmuChkChar},				// Upper Ascii

	{NEW_STATE, 0, 0, 0}, // State 1								// Esc
	{0, ECHAR_CAST('\x31'),	ECHAR_CAST('\x37'),	nothing},					// 1 - 7
	{0, ECHAR_CAST('\x41'),	ECHAR_CAST('\x49'),	EmuViewdataSetAttr},		// A - I
	{0, ECHAR_CAST('\x4C'),	ECHAR_CAST('\x4D'),	EmuViewdataSetAttr},		// L - M
	{0, ECHAR_CAST('\x51'),	ECHAR_CAST('\x5A'),	EmuViewdataSetAttr},		// Q - Z
	{0, ECHAR_CAST('\x5C'),	ECHAR_CAST('\x5D'),	EmuViewdataSetAttr},		// \ - ]
	{0, ECHAR_CAST('\x5E'),	ECHAR_CAST('\x5E'),	EmuViewdataMosaicHold}, 	// ^
	{0, ECHAR_CAST('\x5F'),	ECHAR_CAST('\x5F'),	EmuViewdataMosaicRelease},	// _
	};
	...
	hhEmu->emu_highchar = ECHAR_CAST('\x7F');
