...
#define EMU_TN3270                      120
#define EMU_TN5250                      121
...
#define EMU_TN3270_MAX_LUNAME       64
#define EMU_TN3270_MAX_PATH         260
#define EMU_TN3270_MAX_CODEPAGE     32
#define EMU_TN3270_MAX_OPTIONS      260
#define EMU_TN5250_MAX_NAME         64
#define EMU_TN5250_MAX_PATH         260
#define EMU_TN5250_MAX_CODEPAGE     32
#define EMU_TN5250_MAX_OPTIONS      260
#define EMU_VIDEOTEX_MAX_PROFILE    32
#define EMU_VIDEOTEX_MAX_HOST       128

#define EMU_TN3270_TLS_OFF          0
#define EMU_TN3270_TLS_DIRECT       1
#define EMU_TN3270_TLS_STARTTLS     2
#define EMU_TN5250_TLS_OFF          0
#define EMU_TN5250_TLS_DIRECT       1
...
struct emuSettings
    ...
    int     nTn3270Model;       // 2, 3, 4, or 5.
    int     fTn3270Tls;         // TLS requested for TN3270 connections.
    int     fTn3270Printer;     // Associated 3287 printer requested.
    int     nTn3270TlsMode;     // 0 off, 1 direct TLS, 2 STARTTLS.
    int     fTn3270VerifyCert;  // Verify TLS certificates when TLS is used.
    WCHAR   acTn3270LuName[EMU_TN3270_MAX_LUNAME];
    WCHAR   acTn3270DeviceName[EMU_TN3270_MAX_LUNAME];
    WCHAR   acTn3270HostCodePage[EMU_TN3270_MAX_CODEPAGE];
    WCHAR   acTn3270CaPath[EMU_TN3270_MAX_PATH];
    WCHAR   acTn3270CertPath[EMU_TN3270_MAX_PATH];
    WCHAR   acTn3270KeyPath[EMU_TN3270_MAX_PATH];
    WCHAR   acTn3270IndFileDir[EMU_TN3270_MAX_PATH];
    WCHAR   acTn3270IndFileOptions[EMU_TN3270_MAX_OPTIONS];
    WCHAR   acTn3270PrinterLu[EMU_TN3270_MAX_LUNAME];
    WCHAR   acTn3270PrinterOptions[EMU_TN3270_MAX_OPTIONS];
    int     fTn5250Tls;         // TLS requested for TN5250 connections.
    int     fTn5250Printer;     // Associated 5250 printer requested.
    int     nTn5250TlsMode;     // 0 off, 1 direct TLS.
    int     fTn5250VerifyCert;  // Verify TLS certificates when TLS is used.
    WCHAR   acTn5250TermType[EMU_TN5250_MAX_NAME];
    WCHAR   acTn5250DeviceName[EMU_TN5250_MAX_NAME];
    WCHAR   acTn5250HostCodePage[EMU_TN5250_MAX_CODEPAGE];
    WCHAR   acTn5250CaPath[EMU_TN5250_MAX_PATH];
    WCHAR   acTn5250CertPath[EMU_TN5250_MAX_PATH];
    WCHAR   acTn5250KeyPath[EMU_TN5250_MAX_PATH];
    WCHAR   acTn5250PrinterDevice[EMU_TN5250_MAX_NAME];
    WCHAR   acTn5250PrinterOptions[EMU_TN5250_MAX_OPTIONS];
