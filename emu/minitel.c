...
void emuMinitelInit(const HHEMU hhEmu)
	...
	static struct trans_entry const minitel_tbl[] =
		{
		{NEW_STATE, 0, 0, 0}, // 0
		{0, ECHAR_CAST('\x00'), ECHAR_CAST('\x01'), nothing},
		{0, ECHAR_CAST('\x20'), ECHAR_CAST('\x7F'), minitelGraphic},
		{1, ECHAR_CAST('\x1B'), ECHAR_CAST('\x1B'), nothing},
		{0, ECHAR_CAST('\x07'), ECHAR_CAST('\x07'), emu_bell},

		{0, ECHAR_CAST('\b'),   ECHAR_CAST('\b'), minitelBackspace},
		{0, ECHAR_CAST('\t'),   ECHAR_CAST('\t'),	minitelHorzTab},
		{0, ECHAR_CAST('\n'),   ECHAR_CAST('\n'),	minitelLinefeed},
		{0, ECHAR_CAST('\x0B'), ECHAR_CAST('\x0B'), minitelVerticalTab},
		{0, ECHAR_CAST('\x0C'), ECHAR_CAST('\x0C'), minitelFormFeed},
		{0, ECHAR_CAST('\r'),   ECHAR_CAST('\r'),	carriagereturn},
		{0, ECHAR_CAST('\x0E'), ECHAR_CAST('\x0F'), minitelCharSet},  // change char set
		{0, ECHAR_CAST('\x11'), ECHAR_CAST('\x11'), minitelCursorOn}, // cursor on
		{5, ECHAR_CAST('\x12'), ECHAR_CAST('\x12'), nothing},		  // repeat
		{12,ECHAR_CAST('\x13'), ECHAR_CAST('\x13'), nothing},		  // SEP
		{0, ECHAR_CAST('\x14'), ECHAR_CAST('\x14'), minitelCursorOff},// cursor off
		{20,ECHAR_CAST('\x16'), ECHAR_CAST('\x16'), nothing},		  // SS2 (undocumented)
		{0, ECHAR_CAST('\x18'), ECHAR_CAST('\x18'), minitelCancel},   // cancel
		{20,ECHAR_CAST('\x19'), ECHAR_CAST('\x19'), nothing}, 	  // SS2
		{0, ECHAR_CAST('\x1C'), ECHAR_CAST('\x1C'), nothing}, // really is nothing.
		{13,ECHAR_CAST('\x1D'), ECHAR_CAST('\x1D'), nothing}, // SS3,X ingnored, p99, 1.2.7
		{0, ECHAR_CAST('\x1E'), ECHAR_CAST('\x1E'), minitelRecordSeparator},
		{3, ECHAR_CAST('\x1F'), ECHAR_CAST('\x1F'), nothing}, // Unit Seperator
		//{0, ECHAR_CAST('\x7F'), ECHAR_CAST('\x7F'), minitelDel},

		{NEW_STATE, 0, 0, 0}, // 1 - seen ESC
		{1, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x01'), ECHAR_CAST('\x1F'), minitelResync},
		{18,ECHAR_CAST('\x23'), ECHAR_CAST('\x23'), nothing},
		{14,ECHAR_CAST('\x25'), ECHAR_CAST('\x25'), nothing},
		{13,ECHAR_CAST('\x35'), ECHAR_CAST('\x37'), nothing},	// eat ESC,35-37,X sequences
		{6, ECHAR_CAST('\x39'), ECHAR_CAST('\x39'), nothing},	// PROT1, p134
		{7, ECHAR_CAST('\x3A'), ECHAR_CAST('\x3A'), nothing},	// PROT2, p134
		{8, ECHAR_CAST('\x3B'), ECHAR_CAST('\x3B'), nothing},	// PROT3, p134
		{2, ECHAR_CAST('\x5B'), ECHAR_CAST('\x5B'), ANSI_Pn_Clr},
		{0, ECHAR_CAST('\x40'), ECHAR_CAST('\x49'), emuMinitelCharAttr}, // forground color, flashing
		{0, ECHAR_CAST('\x4C'), ECHAR_CAST('\x4F'), emuMinitelCharAttr}, // char width & height
		{0, ECHAR_CAST('\x50'), ECHAR_CAST('\x5A'), emuMinitelFieldAttr},// background, underlining
		{0, ECHAR_CAST('\x5F'), ECHAR_CAST('\x5F'), emuMinitelFieldAttr},// reveal display
		{0, ECHAR_CAST('\x5C'), ECHAR_CAST('\x5D'), emuMinitelCharAttr}, // inverse
		{0, ECHAR_CAST('\x61'), ECHAR_CAST('\x61'), minitelCursorReport},
		{22,ECHAR_CAST('\x20'), ECHAR_CAST('\x2F'), nothing}, // p.99 ISO 2022

		{NEW_STATE, 0, 0, 0}, // 2 - seen ESC [
		{2, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{2, ECHAR_CAST('\x30'), ECHAR_CAST('\x39'), ANSI_Pn},
		{2, ECHAR_CAST('\x3B'), ECHAR_CAST('\x3B'), ANSI_Pn_End},
		{2, ECHAR_CAST('\x3A'), ECHAR_CAST('\x3F'), ANSI_Pn},
		{0, ECHAR_CAST('\x40'), ECHAR_CAST('\x40'), minitelInsChars},
		{0, ECHAR_CAST('\x41'), ECHAR_CAST('\x41'), minitelCursorUp},
		{0, ECHAR_CAST('\x42'), ECHAR_CAST('\x42'), ANSI_CUD},
		{0, ECHAR_CAST('\x43'), ECHAR_CAST('\x43'), ANSI_CUF},
		{0, ECHAR_CAST('\x44'), ECHAR_CAST('\x44'), ANSI_CUB},
		{0, ECHAR_CAST('\x48'), ECHAR_CAST('\x48'), minitelCursorDirect},
		{0, ECHAR_CAST('\x4A'), ECHAR_CAST('\x4A'), minitelClrScrn},
		{0, ECHAR_CAST('\x4B'), ECHAR_CAST('\x4B'), minitelClrLn},
		{0, ECHAR_CAST('\x4C'), ECHAR_CAST('\x4C'), minitelInsRows},
		{0, ECHAR_CAST('\x4D'), ECHAR_CAST('\x4D'), minitelDelRows},
		{0, ECHAR_CAST('\x50'), ECHAR_CAST('\x50'), minitelDelChars},
		{0, ECHAR_CAST('\x68'), ECHAR_CAST('\x69'), minitelInsMode},
		{0, ECHAR_CAST('\x7A'), ECHAR_CAST('\x7B'), nothing}, //* p144 12.2
		{0, ECHAR_CAST('\x7D'), ECHAR_CAST('\x7D'), nothing}, //* p144 12.2
		{0, ECHAR_CAST('\x7F'), ECHAR_CAST('\x7F'), minitelResetTerminal}, //* p145, 13.2

		{NEW_STATE, 0, 0, 0}, // 3 - unit separtor character position
		{3, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{4, ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), minitelUSRow},

		{NEW_STATE, 0, 0, 0}, // 4 - end of unit separtor character position
		{4, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), minitelUSCol},

		{NEW_STATE, 0, 0, 0}, // 5 - number of repeats
		{5, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x40'), ECHAR_CAST('\x7F'), minitelRepeat},
		{0, ECHAR_CAST('\x00'), ECHAR_CAST('\xFF'), minitelResync},

		{NEW_STATE, 0, 0, 0}, // 6 - Protocol 1 sequence (PRO1,X)
		{6, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), minitelPRO1},

		{NEW_STATE, 0, 0, 0}, // 7 - Protocol 2 sequence (PRO2,X,Y)
		{7, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{8, ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), minitelPRO2Part1},

		{NEW_STATE, 0, 0, 0}, // 8 - Protocol 2 sequence (PRO2,X,Y)
		{8, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), minitelPRO2Part2},

		{NEW_STATE, 0, 0, 0}, // 9 - Protocol 3 sequence (PRO3,X,Y,Z)
		{9, ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{10,ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), nothing},

		{NEW_STATE, 0, 0, 0}, // 10 - Protocol 3 sequence (PRO3,X,Y,Z)
		{10,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{11,ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), nothing},

		{NEW_STATE, 0, 0, 0}, // 11 - Protocol 3 sequence (PRO3,X,Y,Z)
		{11,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), nothing},

		{NEW_STATE, 0, 0, 0}, // 12 - SEP
		{12,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), nothing},

		{NEW_STATE, 0, 0, 0}, // 13 - ESC,35-39,X sequences eaten, p99, 1.2.7
		{13,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x01'), ECHAR_CAST('\xFF'), nothing},

		{NEW_STATE, 0, 0, 0}, // 14 - screen transparency mode
		{15,ECHAR_CAST('\x1B'), ECHAR_CAST('\x1B'), nothing},
		{14,ECHAR_CAST('\x00'), ECHAR_CAST('\xFF'), nothing},
		{23,ECHAR_CAST('\x20'), ECHAR_CAST('\x2F'), nothing}, // could be ISO 2022

		{NEW_STATE, 0, 0, 0}, // 15 - screen transparency mode continued, seen ESC
		{16,ECHAR_CAST('\x25'), ECHAR_CAST('\x25'), nothing},
		{17,ECHAR_CAST('\x2F'), ECHAR_CAST('\x2F'), nothing},
		{15,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{14,ECHAR_CAST('\x00'), ECHAR_CAST('\xFF'), nothing},

		{NEW_STATE, 0, 0, 0}, // 16 - screen transparency mode continued, seen ESC \x25
		{0, ECHAR_CAST('\x40'), ECHAR_CAST('\x40'), nothing},
		{16,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{14,ECHAR_CAST('\x00'), ECHAR_CAST('\xFF'), nothing},

		{NEW_STATE, 0, 0, 0}, // 17 - screen transparency mode continued, seen ESC \x2F
		{0, ECHAR_CAST('\x3F'), ECHAR_CAST('\x3F'), nothing},
		{17,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{14,ECHAR_CAST('\x00'), ECHAR_CAST('\xFF'), nothing},

		{NEW_STATE, 0, 0, 0}, // 18 - Full screen reveal/hide, seen ESC \x23
		{18,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{19,ECHAR_CAST('\x20'), ECHAR_CAST('\x20'), nothing},
		{23,ECHAR_CAST('\x20'), ECHAR_CAST('\x2F'), nothing}, // could be ISO 2022

		{NEW_STATE, 0, 0, 0}, // 19 - Full screen reveal/hide, seen ESC \x23 \x20
		{19,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x58'), ECHAR_CAST('\x58'), minitelFullScrnConceal},
		{0, ECHAR_CAST('\x5F'), ECHAR_CAST('\x5F'), minitelFullScrnReveal},

		{NEW_STATE, 0, 0, 0}, // 20 - SS2
		{20,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x00'), ECHAR_CAST('\x1F'), minitelResync},
		{21,ECHAR_CAST('\x20'), ECHAR_CAST('\x7F'), minitelSS2}, // valid SS2

		{NEW_STATE, 0, 0, 0}, // 21 - SS2 part 2
		{21,ECHAR_CAST('\x00'), ECHAR_CAST('\x00'), nothing},
		{0, ECHAR_CAST('\x20'), ECHAR_CAST('\x7F'), minitelSS2Part2}, // valid SS2

		{NEW_STATE, 0, 0, 0}, // 22 - p.99 ISO 2022
		{23,ECHAR_CAST('\x20'), ECHAR_CAST('\x2F'), nothing},
		{0, ECHAR_CAST('\x00'), ECHAR_CAST('\x1F'), minitelResync},

		{NEW_STATE, 0, 0, 0}, // 23 - p.99 ISO 2022
		{24,ECHAR_CAST('\x20'), ECHAR_CAST('\x2F'), nothing},
		{0, ECHAR_CAST('\x00'), ECHAR_CAST('\x1F'), minitelResync},

		{NEW_STATE, 0, 0, 0}, // 24 - p.99 ISO 2022
		{25, ECHAR_CAST('\x30'), ECHAR_CAST('\x3F'), nothing}, // page 107.
		{0,  ECHAR_CAST('\x30'), ECHAR_CAST('\x7E'), nothing}, // final character
		{0,  ECHAR_CAST('\x00'), ECHAR_CAST('\x1F'), minitelResync},

		{NEW_STATE, 0, 0, 0}, // 25 - p.99 ISO 2022
		{0,  ECHAR_CAST('\x0D'), ECHAR_CAST('\x0D'), nothing}, // page 107. eat CR
		{0,  ECHAR_CAST('\x00'), ECHAR_CAST('\x7F'), minitelResync},
		};
	...
	pstPRI->minitel_last_char = ECHAR_CAST(' ');
...
void minitelGraphic(const HHEMU hhEmu)
	...
	if (ccode == ECHAR_CAST('\x20') && pstPRI->stLatentAttr.fModified
			&& pstPRI->minitelG1Active == FALSE)
		{
		r = hhEmu->emu_imgrow;
	...
	//
	if (tp[col] == ECHAR_CAST('\x7F'))
		{
		tp[col] = ECHAR_CAST('\x5F');
		ap[col].symbol = 1;
		}
	...
	if (++col > hhEmu->emu_maxcol)
		...
		CnvrtHostToECHAR(aechBuf, sizeof(aechBuf), L"\r\n",
			StrCharGetByteCount(L"\r\n"));
...
static void emuMinitelRedisplayLine(const HHEMU hhEmu,
	...
	for (i = col ; i <= hhEmu->emu_maxcol ; ++i)
		...
		if (tp[i] == ECHAR_CAST('\x20') && pstMT[i].isattr)
			ap[i].undrln = 0;
...
void emuMinitelCharAttr(const HHEMU hhEmu)
	...
	switch (hhEmu->emu_code)
		{
	case ECHAR_CAST('\x40'):	 stAttr.txtclr = 0;  break;
	case ECHAR_CAST('\x41'):	 stAttr.txtclr = 12; /*4*/	break;
	case ECHAR_CAST('\x42'):	 stAttr.txtclr = 10; /*2*/	break;
	case ECHAR_CAST('\x43'):	 stAttr.txtclr = 14; /*6*/	break;
	case ECHAR_CAST('\x44'):	 stAttr.txtclr = 9;  /*1*/	break;
	case ECHAR_CAST('\x45'):	 stAttr.txtclr = 13; /*5*/	break;
	case ECHAR_CAST('\x46'):	 stAttr.txtclr = 11; /*3*/	break;
	case ECHAR_CAST('\x47'):	 stAttr.txtclr = 15; break;

	case ECHAR_CAST('\x48'):	 stAttr.blink  = 1;  break;
	case ECHAR_CAST('\x49'):	 stAttr.blink  = 0;  break;

	case ECHAR_CAST('\x4C'):			// normal size
		if (pstPRI->minitelG1Active)
			return;
	...
	case ECHAR_CAST('\x4D'):			// double height
	...
	case ECHAR_CAST('\x4E'):			// double width
		if (pstPRI->minitelG1Active || hhEmu->emu_currow < 1)
			return;
	...
	case ECHAR_CAST('\x4F'):			// double size
		if (pstPRI->minitelG1Active || hhEmu->emu_currow <= 1)
			return;
	...
	case ECHAR_CAST(ECHAR_CAST('\x5C')):    // normal polarity
		if (pstPRI->minitelG1Active)
			return;
	...
	case ECHAR_CAST(ECHAR_CAST('\x5D')):    // reverse polarity
		if (pstPRI->minitelG1Active)
			return;
...
void emuMinitelFieldAttr(const HHEMU hhEmu)
	...
	switch (hhEmu->emu_code)
		{
	case ECHAR_CAST('\x50'):	 pstLA->bkclr = 0;	 break;
	case ECHAR_CAST('\x51'):	 pstLA->bkclr = 12;  break;
	case ECHAR_CAST('\x52'):	 pstLA->bkclr = 10;  break;
	case ECHAR_CAST('\x53'):	 pstLA->bkclr = 14;  break;
	case ECHAR_CAST('\x54'):	 pstLA->bkclr = 9;	 break;
	case ECHAR_CAST('\x55'):	 pstLA->bkclr = 13;  break;
	case ECHAR_CAST('\x56'):	 pstLA->bkclr = 11;  break;
	case ECHAR_CAST('\x57'):	 pstLA->bkclr = 15;  break;

	case ECHAR_CAST('\x58'):	 pstLA->conceal=1;	 break;
	case ECHAR_CAST('\x5F'):	 pstLA->conceal=0;	 break;

	case ECHAR_CAST('\x59'):	// separated mosaics off
		if (pstPRI->minitelG1Active)
			{
	...
	case ECHAR_CAST('\x5A'):	// separated mosaics on
		if (pstPRI->minitelG1Active)
			{
	...
	if ((index = emuKbdKeyLookup(hhEmu, key, &hhEmu->stEmuKeyTbl)) != -1)
		...
		if (!fTest)
			...
			if (key == (VK_RIGHT | VIRTUAL_KEY | SHIFT_KEY) ||
				...
				{
				c = (pstPRI->minitelSecondDep) ? L'\x6c' : L'\x68';
...
void minitelCharSet(const HHEMU hhEmu)
	...
	if (hhEmu->emu_code == ECHAR_CAST(0x0E)) // switch to G1
		{
...
static ECHAR minitelMapMosaics(const HHEMU hhEmu, ECHAR ch)
	...
	if (ch >= ECHAR_CAST('\x21') && ch <= ECHAR_CAST('\x3F'))
		ch += ECHAR_CAST('\x1F');

	// Another weird undocumented affect.  Columns 4 and 5 (except 5F)
	// map to columns 6 and 7 (page 101)
    //
	else if (ch >= ECHAR_CAST('\x40') && ch <= ECHAR_CAST('\x5E'))
		ch += ECHAR_CAST('\x20');

	else if (ch >= ECHAR_CAST('\x60') && ch <= ECHAR_CAST('\x7E'))
		ch += 0;

	if (pstPRI->minitelUseSeparatedMosaics && ch >= ECHAR_CAST('\x21') &&
		ch <= ECHAR_CAST('\x7F'))
		{
		ch += ECHAR_CAST('\x40');
		}
...
void minitelCursorReport(const HHEMU hhEmu)
	...
	wsprintf(ach, L"US%c%c", hhEmu->emu_currow, hhEmu->emu_curcol);

	CnvrtHostToECHAR(aech, sizeof(aech), ach,
        StrCharGetByteCount(ach) + sizeof(WCHAR));
...
static void minitelSS2(const HHEMU hhEmu)
	...
	switch (hhEmu->emu_code)
		{
	case ECHAR_CAST('\x23'):	hhEmu->emu_code = ECHAR_CAST('\xA3');  break; // british pound
	case ECHAR_CAST('\x24'):	hhEmu->emu_code = ECHAR_CAST('\x24');  break; // Dollar sign
	case ECHAR_CAST('\x26'):	hhEmu->emu_code = ECHAR_CAST('\x23');  break; // pound sign
	case ECHAR_CAST('\x27'):	hhEmu->emu_code = ECHAR_CAST('\xA7');  break; // integral
	case ECHAR_CAST('\x2C'):	hhEmu->emu_code = ECHAR_CAST('\xC3');  break; // left arrow
	case ECHAR_CAST('\x2D'):	hhEmu->emu_code = ECHAR_CAST('\xC0');  break; // up arrow
	case ECHAR_CAST('\x2E'):	hhEmu->emu_code = ECHAR_CAST('\xC4');  break; // right arrow
	case ECHAR_CAST('\x2F'):	hhEmu->emu_code = ECHAR_CAST('\xC5');  break; // down arrow
	case ECHAR_CAST('\x30'):	hhEmu->emu_code = ECHAR_CAST('\xB0');  break; // degree
	case ECHAR_CAST('\x31'):	hhEmu->emu_code = ECHAR_CAST('\xB1');  break; // plus-minus
	case ECHAR_CAST('\x38'):	hhEmu->emu_code = ECHAR_CAST('\xF7');  break; // divide
	case ECHAR_CAST('\x3C'):	hhEmu->emu_code = ECHAR_CAST('\xBC');  break; // 1/4
	case ECHAR_CAST('\x3D'):	hhEmu->emu_code = ECHAR_CAST('\xBD');  break; // 1/2
	case ECHAR_CAST('\x3E'):	hhEmu->emu_code = ECHAR_CAST('\xBE');  break; // 3/4
	case ECHAR_CAST('\x41'):	hhEmu->emu_code = ECHAR_CAST('\x60');  fNoAdvance = TRUE;  break;
	case ECHAR_CAST('\x42'):	hhEmu->emu_code = ECHAR_CAST('\xB4');  fNoAdvance = TRUE;  break;
	case ECHAR_CAST('\x43'):	hhEmu->emu_code = ECHAR_CAST('\x5E');  fNoAdvance = TRUE;  break;
	case ECHAR_CAST('\x48'):	hhEmu->emu_code = ECHAR_CAST('\xA8');  fNoAdvance = TRUE;  break;
	case ECHAR_CAST('\x4A'): hhEmu->emu_code = ECHAR_CAST('\xB8');  fNoAdvance = TRUE;  break;
	case ECHAR_CAST('\x4B'): hhEmu->emu_code = ECHAR_CAST('\xB8');  fNoAdvance = TRUE;  break;
	case ECHAR_CAST('\x6A'):	hhEmu->emu_code = ECHAR_CAST('\x8C');  break;
	case ECHAR_CAST('\x7A'):	hhEmu->emu_code = ECHAR_CAST('\x9C');  break;
	case ECHAR_CAST('\x7B'):	hhEmu->emu_code = ECHAR_CAST('\xDF');  break;
	default: hhEmu->emu_code = ECHAR_CAST('\x5F');			 break;
		}
...
static void minitelSS2Part2(const HHEMU hhEmu)
	...
	case ECHAR_CAST('a'):
		switch (pstPRI->minitel_last_char)
			{
		case ECHAR_CAST('\x60'):	hhEmu->emu_code = ECHAR_CAST('\xE0');    break;
		case ECHAR_CAST('\x5E'):	hhEmu->emu_code = ECHAR_CAST('\xE2');    break;
		case ECHAR_CAST('\xA8'):	hhEmu->emu_code = ECHAR_CAST('\xE4');    break;
		default: break;
			}
		break;
	...
	case ECHAR_CAST('e'):
		switch (pstPRI->minitel_last_char)
			{
		case ECHAR_CAST('\x60'):	hhEmu->emu_code = ECHAR_CAST('\xE8');    break;
		case ECHAR_CAST('\xB4'):	hhEmu->emu_code = ECHAR_CAST('\xE9');    break;
		case ECHAR_CAST('\x5E'):	hhEmu->emu_code = ECHAR_CAST('\xEA');    break;
		case ECHAR_CAST('\xA8'):	hhEmu->emu_code = ECHAR_CAST('\xEB');    break;
		default: break;
			}
		break;
	...
	case ECHAR_CAST('i'):
		switch (pstPRI->minitel_last_char)
			{
		case ECHAR_CAST('\x5E'):	hhEmu->emu_code = ECHAR_CAST('\xEE');    break;
		case ECHAR_CAST('\xA8'):	hhEmu->emu_code = ECHAR_CAST('\xEF');    break;
		default: break;
			}
		break;
	...
	case ECHAR_CAST('o'):
		switch (pstPRI->minitel_last_char)
			{
		case ECHAR_CAST('\x5E'):	hhEmu->emu_code = ECHAR_CAST('\xF4');    break;
		case ECHAR_CAST('\xA8'):	hhEmu->emu_code = ECHAR_CAST('\xF6');    break;
		default: break;
			}
		break;
	...
	case ECHAR_CAST('u'):
		switch (pstPRI->minitel_last_char)
			{
		case ECHAR_CAST('\x60'):	hhEmu->emu_code = ECHAR_CAST('\xF9');    break;
		case ECHAR_CAST('\x5E'):	hhEmu->emu_code = ECHAR_CAST('\xFB');    break;
		case ECHAR_CAST('\xA8'):	hhEmu->emu_code = ECHAR_CAST('\xFC');    break;
		default: break;
			}
		break;
	...
	case ECHAR_CAST('c'):
		switch (pstPRI->minitel_last_char)
			{
		case ECHAR_CAST('\xB8'): hhEmu->emu_code = ECHAR_CAST('\xE7');	break;
		default: break;
			}
		break;
...
static void minitelInsMode(const HHEMU hhEmu)
	{
	hhEmu->mode_IRM = (hhEmu->emu_code == ECHAR_CAST('\x68')) ? SET : RESET;
	return;
	}
...
static void minitelPRO2Part2(const HHEMU hhEmu)
	...
	switch (hhEmu->emu_code)
		{
	case ECHAR_CAST('\x43'):	  // scrolling
		if (pstPRI->minitel_PRO1 == ECHAR_CAST('\x69'))
			pstPRI->fScrollMode = TRUE;

		if (pstPRI->minitel_PRO1 == ECHAR_CAST('\x6A'))
			pstPRI->fScrollMode = FALSE;

		minitelStatusReply(hhEmu);
		break;

	case ECHAR_CAST('\x44'):	  // error correction procedure (not implemented)
		break;

	case ECHAR_CAST('\x45'):	  // keyboard upper/lower case
		if (pstPRI->minitel_PRO1 == ECHAR_CAST('\x69'))
			fUpperCase = FALSE;

		else if (pstPRI->minitel_PRO1 == ECHAR_CAST('\x6A'))
			fUpperCase = TRUE;
...
static void minitelStatusReply(const HHEMU hhEmu)
	...
	CnvrtHostToECHAR(ach, sizeof(ach), L"\x1b\x3A\x73",
					 StrCharGetByteCount(L"\x1b\x3A\x73"));

	ach[3] = ECHAR_CAST('\x40');  // bit 7 is always 1.
	ach[3] |= pstPRI->fScrollMode ? ECHAR_CAST('\x02') : ECHAR_CAST('\x00');
	ach[3] |=(GetKeyState(VK_CAPITAL) > 0) ? ECHAR_CAST('\x00') : ECHAR_CAST('\x08');
	ach[4] = ECHAR_CAST('\0');
...
void emuMinitelSendKey(const HEMU hEmu, const int iCmd)
	...
	switch (iCmd)
		{
	case IDM_MINITEL_INDEX: 	pach = L"\x13" L"F";	   break;
	case IDM_MINITEL_CANCEL:	pach = L"\x13" L"E";	   break;
	case IDM_MINITEL_PREVIOUS:	pach = L"\x13" L"B";	   break;
	case IDM_MINITEL_REPEAT:	pach = L"\x13" L"C";	   break;
	case IDM_MINITEL_GUIDE: 	pach = L"\x13" L"D";	   break;
	case IDM_MINITEL_CORRECT:	pach = L"\x13" L"G";	   break;
	case IDM_MINITEL_NEXT:		pach = L"\x13" L"H";	   break;
	case IDM_MINITEL_SEND:		pach = L"\x13" L"A";	   break;
    ...
    if (bSendKey == TRUE)
        {
	    CnvrtHostToECHAR(aechBuf, sizeof(aechBuf), pach,
		    StrCharGetByteCount(pach) + sizeof(WCHAR));
