...
struct xfer_protocol
	{
	int nProtocol;
        WCHAR acName[40];                       /* that should be big enough. JPN needs 32bytes at least*/
	};
...
struct xfer_receive
	...
	LPWSTR pszDir;				/* prototype directory string */
	LPWSTR pszName;				/* prototype filename string */
	};
