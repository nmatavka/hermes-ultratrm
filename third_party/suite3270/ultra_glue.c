 ...
 * emu/ibm3270.c and ultra_runtime.c. This small unit gives CMake a distinct
 * IBM 3270 glue library boundary, matching the upstream-style split and
 * keeping future GUI/timer/task hook expansion out of the protocol core.
 */

#include "ultra_runtime.h"

int ibm3270_ultra_glue_anchor(void)
    {
